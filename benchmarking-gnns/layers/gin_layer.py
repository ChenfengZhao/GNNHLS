...
class MLP(nn.Module):
    ...
    def __init__(self, num_layers, input_dim, hidden_dim, output_dim):
        ...
        if num_layers < 1:
            ...
            # Linear model
            self.linear = nn.Linear(input_dim, output_dim, bias=self.bias)
        else:
            # Multi-layer model
            ...
            self.linears.append(nn.Linear(input_dim, hidden_dim, bias=self.bias))
            for layer in range(num_layers - 2):
                self.linears.append(nn.Linear(hidden_dim, hidden_dim, bias=self.bias))
            self.linears.append(nn.Linear(hidden_dim, output_dim, bias=self.bias))
