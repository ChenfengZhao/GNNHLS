...
from data.OGBG import OGBGDataset
...
def LoadData(DATASET_NAME):
    ...
    if 'ogbg' in DATASET_NAME:
        print("Using ogb graph classification dataset: ", DATASET_NAME)
        return OGBGDataset(DATASET_NAME)
    
    if 'ogbn' in DATASET_NAME:
        print("Using ogb node classification dataset: ", DATASET_NAME)
